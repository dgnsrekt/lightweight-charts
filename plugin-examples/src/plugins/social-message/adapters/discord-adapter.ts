 ...
 * Provides Discord-specific branding, theming, and icon rendering.
 */
...
/**
 * Discord Adapter - implements Discord-specific behavior
 */
export class DiscordAdapter implements IPlatformAdapter {
	public readonly platformName = 'discord';

	getBrandColor(): string {
		return DISCORD_BRAND_COLOR;
	}
